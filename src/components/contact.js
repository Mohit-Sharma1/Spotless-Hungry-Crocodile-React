...
Contact.defaultProps = {
  content4:
    'Follow us on social media for the latest insights and trends in remote work.',
  phone1: '+1-234-567-8901',
  content3:
    'Stay connected with us for updates, news, and tips on remote work.',
  heading1: 'Contact Us',
  content5: 'Join our newsletter to receive exclusive content and updates.',
  content2:
    'Our team is here to assist you with any inquiries or support needs.',
  content1:
    'Have a question or want to learn more about WorkSphere? Reach out to us!',
  email1: 'info@worksphere.com',
  address1: '123 WorkSphere Street, Remote City, RS',
}
