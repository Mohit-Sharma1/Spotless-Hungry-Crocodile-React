...
Steps.defaultProps = {
  step3Title: 'Continuous AI Enhancements',
  step2Title: 'Enterprise & SME Adoption',
  step4Title: 'Step 4',
  step1Description: 'Gather user feedback & optimize AI models',
  step4Description:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla.',
  step2Description: 'Offer tailored solutions for different organizations',
  step1Title: 'Beta Testing with Remote Teams',
  step3Description: 'Improve features based on real-world data',
}
